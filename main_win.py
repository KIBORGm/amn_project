...
"}")
        ...
        self.label.setStyleSheet("font: 75 12pt \"Century Gothic\";")
...
"}")
        ...
        self.verticalLayout_19 = QtWidgets.QVBoxLayout(self.pg_hello)
        self.verticalLayout_19.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout_19.setSpacing(0)
        self.verticalLayout_19.setObjectName("verticalLayout_19")
        self.frame_top_opt_2 = QtWidgets.QFrame(parent=self.pg_hello)
        self.frame_top_opt_2.setStyleSheet("\n"
"background-color: rgb(81, 81, 81);\n"
"\n"
"")
        self.frame_top_opt_2.setFrameShape(QtWidgets.QFrame.Shape.NoFrame)
        self.frame_top_opt_2.setFrameShadow(QtWidgets.QFrame.Shadow.Raised)
        self.frame_top_opt_2.setObjectName("frame_top_opt_2")
        self.verticalLayout_12 = QtWidgets.QVBoxLayout(self.frame_top_opt_2)
        self.verticalLayout_12.setObjectName("verticalLayout_12")
        self.label_18 = QtWidgets.QLabel(parent=self.frame_top_opt_2)
...
"font: 16pt \"Century Gothic\";")
        ...
        self.verticalLayout_19.addWidget(self.frame_top_opt_2)
...
"                     }")
    ...
    def retranslateUi(self, Form):
        ...
        Form.setWindowTitle(_translate("Form", "Социальный компаньон"))
        ...
        self.label_18.setText(_translate("Form", "Добро пожаловать в \"Социальный Компаньон\"!"))
        self.label_3.setText(_translate("Form", "<html><head/><body><p>Мы рады видеть вас здесь. Вместе мы создадим уютное и поддерживающее сообщество. Найдите новых друзей, общение и поддержку. Начнем это удивительное путешествие вместе!</p></body></html>"))
